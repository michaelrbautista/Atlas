                    ...
                    <div className="flex flex-col items-center gap-24 w-4/5 sm:w-[800px]">
                        ...
                        <div className="relative flex items-center w-[350px] h-[200px] sm:w-[800px] sm:h-[400px]">
                            <Image
                                ...
                                fill
                                src="https://ltjnvfgpomlatmtqjxrk.supabase.co/storage/v1/object/public/landing_page/landingPageOne.jpg?t=2025-01-16T04%3A42%3A43.313Z"
                        ...
                        <div className="flex flex-col gap-10">
                            <div className="relative flex items-center w-[350px] h-[300px] sm:w-[600px] sm:h-[400px]">
                                <Image
                                    className="rounded-md"
                                    fill
                                    src="https://ltjnvfgpomlatmtqjxrk.supabase.co/storage/v1/object/public/landing_page/landingPageTwo.jpg?t=2025-01-16T04%3A42%3A59.966Z"
                        ...
                        <div className="flex flex-col items-center gap-10">
                            <div className="relative flex items-center w-[350px] h-[200px] sm:w-[800px] sm:h-[400px]">
                                <Image
                                    className="rounded-md"
                                    fill
                                    src="https://ltjnvfgpomlatmtqjxrk.supabase.co/storage/v1/object/public/landing_page/landingPageThree.jpg?t=2025-01-16T04%3A43%3A08.209Z"
