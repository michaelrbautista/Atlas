...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-systemGray4 text-primary-foreground hover:bg-primary/90",
        systemBlue: "bg-systemBlue text-primaryText hover:bg-systemBlueHover",
        systemGray: "bg-systemGray3 text-primaryText hover:bg-systemGray4",
        disabled: "bg-systemGray4 text-secondaryText pointer-events-none",
        destructive:
