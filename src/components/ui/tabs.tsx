...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center rounded-none bg-systemBackground text-muted-foreground",
      className
    )}
    {...props}
  />
